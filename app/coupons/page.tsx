      ...
      {showForm && (
        <div className="bg-card rounded-xl border border-border p-6 animate-fadeIn">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div>
              <label className="block text-sm font-medium text-stone-700 mb-1.5">Max Discount (₹)</label>
            ...
            <tbody>
              {coupons.map((coupon) => (
                <tr key={coupon._id} className="border-t border-border hover:bg-surface/30 transition-colors">
                  ...
                  <td className="px-6 py-4 text-sm text-stone-600">₹{coupon.minOrderAmount || 0}</td>
                  <td className="px-6 py-4 text-sm text-stone-600">₹{coupon.maxDiscount || 0}</td>
